        ...
        <div id='home' className="banner_section">
            <div className="banner_inner">
                <div className="banner_txt">
                    ...
                    <p className="hero-anim-2">Etlas is Singapore's only locally built physical security platform. We design, install, and manage your complete security stack — end to end.</p>
